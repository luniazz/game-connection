      ...
      <div className="w-full max-w-lg bg-brand-dark/90 backdrop-blur-md p-10 rounded-3xl border border-white/10 shadow-[0_0_50px_rgba(29,229,109,0.1)] relative z-10">
        ...
        <form onSubmit={handleSubmit} noValidate aria-label="Formulário de cadastro" className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full bg-brand-green/5 border ${emailErro ? 'border-red-500' : 'border-brand-green/20'} text-white px-4 py-3.5 rounded-xl focus:outline-none focus:border-brand-green focus:ring-2 focus:ring-brand-green/50 focus:shadow-[0_0_0_4px_rgba(29,229,109,0.1)] transition-all placeholder:text-gray-400`}
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full bg-brand-green/5 border ${senhaErro ? 'border-red-500' : 'border-brand-green/20'} text-white px-4 py-3.5 rounded-xl focus:outline-none focus:border-brand-green focus:ring-2 focus:ring-brand-green/50 focus:shadow-[0_0_0_4px_rgba(29,229,109,0.1)] transition-all placeholder:text-gray-400 pr-12`}
                placeholder="••••••••"
                aria-required="true"
            ...
            <div id="requisitos-senha" aria-label="Requisitos da senha" className="grid grid-cols-2 gap-2 mt-3 ml-1">
          ...
          <div className="flex items-start gap-3 pt-2 ml-1">
            <div className="relative flex items-center mt-0.5">
              <input
                ...
                className="peer h-5 w-5 cursor-pointer appearance-none rounded-md border-2 border-brand-green/40 bg-brand-dark/50 checked:border-brand-green checked:bg-brand-green transition-all hover:border-brand-green focus:outline-none focus:ring-2 focus:ring-brand-green/50 focus:ring-offset-2 focus:ring-offset-brand-dark"
              />
            ...
            <label htmlFor="termos" id="termos-label" className="text-xs text-gray-300 select-none cursor-pointer leading-relaxed">
              Li e aceito a{" "}
              <a href="#" aria-label="Ler Política de Privacidade da Game Connection" className="text-brand-green hover:text-brand-hover underline-offset-2 hover:underline transition-colors">
                Política de Privacidade
              </a>{" "}
              e os{" "}
              <a href="#" aria-label="Ler Termos de Uso da Game Connection" className="text-brand-green hover:text-brand-hover underline-offset-2 hover:underline transition-colors">
                Termos de Uso
              </a>{" "}
              da Game Connection.
            </label>
        ...
        <div role="group" aria-label="Opções de login com redes sociais" className="grid grid-cols-2 gap-4">
          <button
            ...
            className="flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 hover:border-white/20 text-white py-3.5 rounded-xl border border-white/10 transition-all font-bold group focus:outline-none focus:ring-2 focus:ring-brand-green/50 focus:ring-offset-2 focus:ring-offset-brand-dark"
          >
